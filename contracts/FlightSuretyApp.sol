...
contract FlightSuretyApp {
    ...
    */
    modifier requireIsOperational() 
    {
        ...
        require(FSData.isOperational(), "Contract is currently not operational");          _;  // All modifiers require an "_" which indicates where the function body will be added
    }
    ...
    */
                                ...
                                public 
    {
        ...
        FSData = FlightSuretyData(fsdata);
    }
    ...
    //                         external
    // {
    //     FSData = FlightSuretyData(dataAddress);
    // }
    ...
    */   
     ...
     *******************************************/
     ...
     function voteToRegisterAirline(address _airLineAddress) external{
    ...
    */  
    ...
    {
        FSData.processFlightStatus(_airline, _flight, _timestamp, _statusCode);
    }
